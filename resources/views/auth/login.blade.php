...
<head>
    <meta charset="utf-8" />
    <title>Log In | Admin Luxury Chauffeur</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="auth-brand p-4">
                                    <a href="{{ url('/') }}" class="logo-light">
                                        <img src="{{ asset('backend/images/logo.png') }}" alt="logo" height="150">
                                    </a>
                                    <a href="{{ url('/') }}" class="logo-dark">
                                        <img src="{{ asset('backend/images/logo.png') }}" alt="dark logo" height="150">
                                    </a>
                                </div>
...
<footer class="footer footer-alt fw-medium">
    <span class="text-dark">
        <script>document.write(new Date().getFullYear())</script> © Admin Luxury Chauffeur
    </span>
</footer>
